...
INTENT_PATTERNS = {
    ...
    "reminder": ["remind", "reminder", "emi", "bill", "sip", "insurance due"],
    "rag":      ["what is", "define", "explain", "how does", "neft", "rtgs", "imps",
                 "upi", "fd", "fixed deposit", "kyc", "cibil", "credit score",
                 "ifsc", "loan eligibility", "elss", "rd", "recurring deposit",
                 "nominee", "utr", "settlement"],
